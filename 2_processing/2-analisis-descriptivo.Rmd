...
#write.xlsx(desc_table, file = "../3_output/tablas/1_desc_table.xlsx", sheetName = 'data', row.names=FALSE) #guardamos
```
...
elsoc_cor <- elsoc_mean_zonas %>% 
  ...
  drop_na() %>% 
  rename("Apego"="apbi", "Sociabilidad"="soci", "Reputación"="repbi","Seguridad"="segui", "Satisfacción"="sacci",
