...
ismt_jane <- readxl::read_excel("../1_input/data/original/ismt_jane.xlsx")
```
c12_01
c07_01
...
#join con ismt_jane (y a futuro índice de jj)
...
elsoc_gs <- elsoc_d %>% 
  ...
  dplyr::select(idencuesta, #id individual
                ...
                jh_esc_sd, hi_theil, ismtpn, gse_prom, gse_dom, ENTMEAN, ENTWGT, ave_jane = Ave_jan_nd, #desigualdad socioespacial
...
elsoc_gs_short <- elsoc_gs %>% 
  dplyr::select(idencuesta, comuna_w06, comuna_cod_w06, dist, zona, cod_zona, comuna=comuna_w06,cod_comuna=comuna_cod_w06, manzana, #ids
         apbi, apbr, soci, cnfi, comi, segu, segui=t10_w06, sacci, repb, repbi=t08_w06 , #cohesión y mecanismos
         sexo, edad, edadi=m0_edad_w06, educ, educi=m01_w06, essu, essui=d01_01_w06, regi, time, #controles
         hete=jh_esc_sd, segr, hi_theil, ismtpn, gse_prom, gse_dom, ent_mean = ENTMEAN, ent_wgt = ENTWGT, ent_segr, ave_jane) #segregación
