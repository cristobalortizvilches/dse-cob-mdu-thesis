...
mod_1_zon = lmer(apbi ~ 1 + t06_01_w06 + t06_02_w06 + t06_03_w06 + t06_04_w06 + t06_05_w06 + t06_06_w06 + t06_07_w06 + t06_08_w06 + repbi + edadi + educi + time + (1 | cod_zona), data = elsoc_ams)
...
mod_3_zon = lmer(apbi ~ 1 + t06_01_w06 + t06_02_w06 + t06_03_w06 + t06_04_w06 + t06_05_w06 + t06_06_w06 + t06_07_w06 + t06_08_w06 + repbi + edadi + educi + time + jane_conc + jane_divu + jane_edif + jane_opco + jane_acce + jane_dist + ismt_rank + (1 | cod_zona), data = elsoc_ams)
...
```{r}
coef_apbi <-
  broom.mixed::tidy(mod_3_zon, conf.int = T) %>% 
  filter(effect == "fixed",
         !term %in% c("edadi", "educi", "time", "(Intercept)")) 

coef_apbi <- coef_apbi %>% 
  mutate(term = recode(term, 
                       "t06_01_w06" = "Seguridad","t06_02_w06" = "Conectividad",
                       "t06_03_w06" = "Areas verdes","t06_04_w06" = "Limpieza",
                       "t06_05_w06" = "Proximidad a\nprincipal actividad","t06_06_w06" = "Proximidad a\nbuenos colegios",
                       "t06_07_w06" = "Proximidad a\ncomercios","t06_08_w06" = "Proximidad a\nredes cercanas",
                       "repbi" = "Reputación", "edadi" = "Edad", "educi" = "Escolaridad", "time" = "Tiempo residencia", 
                       "jane_conc" = "Concentración", "jane_divu" = "Diversidad usos", "jane_edif" = "Edificios antiguos", 
                       "jane_opco" = "Oportunidades\nde contacto", "jane_acce" = "Accesibilidad", "jane_dist" = "Vacíos fronterizos", 
                       "ismt_rank" = "Nse barrio"))

coef_plot <- coef_apbi %>% 
  ggplot(aes(x = factor(term, levels = c("Seguridad", "Conectividad", "Areas verdes", "Limpieza",  "Proximidad a\nprincipal actividad", 
                                         "Proximidad a\nbuenos colegios", "Proximidad a\ncomercios", "Proximidad a\nredes cercanas", "Reputación",
                                         "Concentración", "Diversidad usos",  "Edificios antiguos", "Oportunidades\nde contacto", "Accesibilidad", 
                                         "Vacíos fronterizos", "Nse barrio")), 
             y = estimate)) +
...
ggsave(coef_plot,filename = "../3_output/graficos/coef-plot-mlm-vit-cob.png", width = 8, height = 8, dpi = 300)
```
