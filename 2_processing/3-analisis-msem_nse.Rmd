...
#elsoc_gs_2022_complete <-  elsoc_sub %>% dplyr::select(idencuesta, cod_zona)
#haven::write_dta(elsoc_gs_2022_complete, "../1_input/data/original/elsoc-manzanas/mzn-elsoc-2012-2017/elsoc_gs_2022_complete.dta")
```
