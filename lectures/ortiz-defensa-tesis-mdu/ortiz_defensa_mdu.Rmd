...
.line_space_07[
### Desigualdad socioespacial y cohesión barrial en el Gran Santiago:
### de los *'efectos de barrio'* a los *'efectos subjetivados'*
DEFENSA DE TESIS PARA EL GRADO DE MAGÍSTER EN DESARROLLO URBANO
]
...
.text_100[Asistente de investigación L4 COES]

<br>

.text_70[**Quentin Ramond y Ricardo Truffelo, profesores guía**]

.text_70[COMISIÓN]

.text_70[**María Luisa Méndez, Luis Fuentes y Alejandra Rasse**]

.text_70[INSTITUTO DE ESTUDIOS URBANOS Y TERRITORIALES - PONTIFICIA UNIVERSIDAD CATÓLICA DE CHILE]
...
#### Gran presencia de la pregunta por la relación entre la desigualdad socioespacial y la cohesión barrial en los últimos 10 años. Pero menos conocimiento sobre *cómo* la estructura socioespacial afecta la cohesión

---

## Objetivo y pregunta

Ante este vacío, **el objetivo** explicar la influencia de e la desigualdad socioespacial mediante mecanismos subjetivos, es decir, a través de indicadores que expresen la experiencia en el barrio. **Rol de la estructura simbólica**
...
knitr::include_graphics('./img/esquema-msem-con.svg')
```
...
knitr::include_graphics('./img/esquema-msem-hip.svg')
```
]
...
.pull-right[
```{r echo=FALSE, out.width = '80%'}
knitr::include_graphics('./img/mapa-defensa.png')
```
]
...
knitr::include_graphics('./img/esquema-msem-met.svg')
```
]
...
class: middle right
background-image: url('./img/coef-plot-4.svg')
background-size: 650px
background-position: left

## ¿Efectos subjetivados?

--

Efecto de **desigualdad** sobre **cohesión** 

ocurre a través de **experiencia** 

???
es decir, **DSE** afecta **COB**, pero sólo porque **DSE** afectó a **EXP** en primer lugar.

--

Efecto mediador es total, es decir, en ausencia de estas

**experiencias**, la **desigualdad** no explica la **cohesión**

--

Destacan dos efectos subjetivados:

Homogeneidad ⬆️ → Reputación ⬇️ → Cohesión ⬇️ 

Vitalidad ⬆️ → Seguridad ⬇️ → Cohesión ⬇️ 

--


### Mediación como *efecto subjetivado*

---

class: inverse, center, middle

## IV.2 Resultados asociativos: relaciones por NSE

---

## H1 (Hallazgo: Homogeneidad ⬆️ → Cohesión ⬇️) 

```{r echo=FALSE, out.width = '90%', fig.align = 'center'}
knitr::include_graphics('./img/scat-homo-cob.svg')
```

---

## H2 (Hallazgo: Vitalidad ⬆️ → Cohesión ⬆️️) 

```{r echo=FALSE, out.width = '90%', fig.align = 'center'}
knitr::include_graphics('./img/scat-vita-cob.svg')
```

---

## H3 (Hallazgo: Mecanismos ⬆️ → Cohesión ⬆️) 

```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/scat-exp-cob.svg')
```
...
#### 2. El *efecto subjetivado de la desigualdad socioespacial* se experimenta diferenciadamente en función del NSE

--

- **NSE alto**
  - Segregación afectiva (Méndez et al. 2020) y no relacional compensada por la vitalidad (Jacobs, 1967) 
  - Relación entre reputación/seguridad y pertenencia es débil, posiblemente su condición socioespacial favorece la pertenencia, independientemente de los factores subjetivos

--

- **NSE medio**. 
  - Homogeneidad deteriora la cohesión (H. Contacto), la familiaridad por vitalidad (Blokland & Nast, 2014)
  - Relación directa positiva entre mecanismos subjetivos y cohesión se mantiene

--

- **NSE bajo** 
  - Segregación con malestar afectivo, pero resistencia relacional (H. de amenaza). Malestar afectivo y relacional a medida que aumenta la vitalidad (forma de "u", (Link et al. 2020))
  - Relación directa positiva entre mecanismos subjetivos y cohesión se mantiene
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result-a1.svg')
```
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result-a2.svg')
```
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result-b1.svg')
```
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result-b2.svg')
```
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result-b3.svg')
```
...
```{r echo=FALSE, out.width = '60%', fig.align = 'center'}
knitr::include_graphics('./img/esquema-msem-4-result.svg')
```
